                    ...
                    <div class="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden flex flex-col sm:flex-row">
                        @if($complaint->photo)
                            <div class="sm:w-48 h-48 sm:h-auto flex-shrink-0">
                                <img src="{{ $complaint->photo }}" class="w-full h-full object-cover" alt="Foto Bukti" onerror="this.parentElement.innerHTML='<div class=\'w-full h-full bg-slate-100 flex items-center justify-center\'><svg class=\'w-10 h-10 text-slate-300\' fill=\'none\' stroke=\'currentColor\' viewBox=\'0 0 24 24\'><path stroke-linecap=\'round\' stroke-linejoin=\'round\' stroke-width=\'2\' d=\'M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z\'/></svg></div>'">
                            </div>
                        @else
